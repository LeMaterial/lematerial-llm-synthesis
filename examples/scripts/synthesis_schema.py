...
schema = pa.schema([
    ...
    ('evaluation', pa.struct([
        ...
        ("scores", pa.struct([
            ...
            ("structural_completeness_reasoning", pa.string()),
            ...
            ("conditions_extraction_reasoning", pa.string()),
