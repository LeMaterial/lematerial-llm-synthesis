#!/usr/bin/env python3
"""
Batch runner for the porous materials / adsorption isotherm case study.

Extracts synthesis procedures and pressure-vs-adsorption isotherm data
from papers on porous materials (MOFs, zeolites, COFs, etc.).
...
DEFAULT_OUTPUT_DIR = "../data/results_porosity"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Batch synthesis + isotherm extraction for porous materials."
        ),
    ...
    runner = BatchRunner(
        domain_config=DomainConfig.for_porosity(),
