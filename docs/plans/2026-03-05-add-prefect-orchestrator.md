...
- [x] Задача 3: Создание Prefect-задач для шагов пайплайна
- [x] Задача 4: Создание основного flow экстракции
- [x] Задача 5: Hydra-конфигурация оркестрации
- [x] Задача 6: Entry point скрипт с Prefect
- [x] Задача 7: Unit-тесты

**Всего задач:** 7 | **Выполнено:** 7 | **Осталось:** 0
